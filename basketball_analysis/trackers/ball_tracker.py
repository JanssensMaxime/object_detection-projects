...
class Balltracker():
    ...
    def detect_frames(self, frames):
        # 20 frames at the same time
        batch_size = 20
        detections = []
        for i in range(0, len(frames), batch_size):
            # taking frames from i to i+batch_size
    ...
    # detect object inside the frame
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            # inversion of keys and values : 0:'person' => 'person':0
            cls_names_inv = {v: k for k, v in cls_names.items()}

            # convert ultralytics output/format to supervision output/format
    ...
    def remove_wrong_detections(self, ball_positions):
        ...
        for i in range(len(ball_positions)):
            ...
            # calculate distance between last bbox and current ball position
