...
class BallAquisitionDetector:
    ...
    def get_key_basketball_player_assigment_points(self, player_bbox, ball_center):
    ...
    def find_minimum_distance_to_ball(self, ball_center, player_bbox):
        key_points = self.get_key_basketball_player_assigment_points(player_bbox, ball_center)
    ...
    def detect_ball_possession(self, player_tracks, ball_tracks):
        ...
        for frame_num in range(num_frames):
            ...
            if best_player_id != -1:
                num_of_consecutive_frames = consecutive_possession_count.get(best_player_id, 0) + 1
                consecutive_possession_count = {best_player_id: num_of_consecutive_frames}
