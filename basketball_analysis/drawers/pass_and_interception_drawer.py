...
class PassInterceptionDrawer:
    ...
    def draw_frame(self, frame, frame_num, passes, interceptions):
        ...
        cv2.putText(frame, f'Team 1 - Passes: {team_1_passes} Interceptions: {team_1_interceptions}',
                    (text_x, text_y1),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    font_scale,
                    (0, 0, 0),
                    font_thickness)
        cv2.putText(frame, f'Team 2 - Passes: {team_2_passes} Interceptions: {team_2_interceptions}',
                    (text_x, text_y2),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    font_scale,
                    (0, 0, 0),
